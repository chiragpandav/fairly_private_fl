...
from models import FullyConnected, FullyConnectedTrainer, LinearModel
...
def calculate_batch_inversion_performance_parallelized(dataset, network_layouts, training_epochs,
    ...
    :param network_layouts: (list) The evaluated network layouts.
    ...
    for i, training_epoch in enumerate(training_epochs):
        ...
        for j, network_layout in enumerate(network_layouts):
            ...
            if network_layout == 'linear':
                net = LinearModel(dataset.num_features, 2)
...
def main(args):
    ...
    network_layouts = ['linear', [50, 2], [100, 2], [100, 100, 2], [200, 200, 200, 2], [400, 400, 400, 2]]
    tol = 0.319
    # ------------ END ------------ #
    ...
    base_path = f'experiment_data/network_size_variation/{args.dataset}/experiment_{args.experiment}/batch_size_{reconstruction_batch_size}'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('run_network_size_experiment_parser')
